...
<div class="inner-div">
  ...
  <h3 for="exampleFormControlFile1">Upload Image</h3><br>
  <input type="file" class="form-control-file" id="exampleFormControlFile1"name="myImage" accept="image/png, image/gif, image/jpeg" /><br><br>
  <button type="button" class="btn btn-outline-light">Manage Permissions <a style="color:white;" href="manage.jsp"> <i class="fa fa-pencil" aria-hidden="true"></i></a></button>

...
<div style="height:400px;" class="inner-div">
  <h2>Send Mail</h2>
  <h5>Mail :</h5>
  <div class="form-group">
    ...
    <div class="form-group">
     ...
     <button href = "" type="button" class="btn btn-outline-success">Send<a href="mailto: nadavadiharshith.gowd2020@vitstudent.ac.in">.</a></button>
  </div>
</div>

<div style="height:400px;bottom:5rem;position:absolute;right:5rem; " class="inner-div">
  <h2>Contact</h2>
  <h5>Mail :</h5>
  <p>nadavadiharshith.gowd2020@vitstudent.ac.in</p>
  <h5>address :</h5>
